...
class FreshStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        vpc_1_public_RT = ec2.CfnRoute(self, "PublicRT",
                                        destination_cidr_block= vpc_2.vpc_cidr_block,
                                        route_table_id= vpc_1.public_subnets[0].route_table.route_table_id,
        ...
        vpc_2_private_RT = ec2.CfnRoute(self, "PrivatRT",
                                        destination_cidr_block=vpc_1.vpc_cidr_block,
                                        route_table_id= vpc_2.isolated_subnets[0].route_table.route_table_id,
                                        vpc_peering_connection_id=vpc_peering.attr_id
                                        )
        ...
        sg_managserver.add_ingress_rule(
            ...
            connection=ec2.Port.tcp(22)),
        'allow SSH traffic from anywhere',
        with open("my_project/user-data-mang.sh", "r") as file:
            mang_user_data = file.read()
        ...
        self.management_server = ec2.Instance(self, "managServer",
            ...
            user_data=ec2.UserData.custom(mang_user_data),
            vpc=vpc_2,
            vpc_subnets=ec2.SubnetSelection(subnet_type=ec2.SubnetType.PUBLIC),
